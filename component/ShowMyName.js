            	...
            	<View>
            		...
            		<View style={styles.word1}>
            			...
            			<View style={styles.little}>
            				...
            				<Icon style={{marginTop:10,backgroundColor:'write'}} color="red"  name="bulb"/>
            				<Text style={{fontSize:16,marginTop:10}} onPress={()=>Actions.two()}>我的发布</Text>
            				
            			</View>
            		</View>
            		<View style={{width:width,height:100}}>
            			<Text style={{marginLeft:200,marginTop:40,color:"red"}} onPress={this.exit}>退出登陆</Text>
            		</View>
            	</View>
